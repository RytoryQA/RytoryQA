...
- Ветвление git и [авто-тесты](https://github.com/RytoryQA/Homework-autotest-1/blob/7087c39504d6ed5ea37fb4905d065da8c895952c/src/test/java/org/example/CashbackHackServiceTest.java), написанные с помощью фреймфорков TestNG и Junit4. В результатте тестирования на основе Issues был заведен [баг-репорт](https://github.com/RytoryQA/Homework-autotest-1/issues/1)
